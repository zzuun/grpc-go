...
type HelloRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // A string field representing the name of the person to greet.
}
...
type HelloResponse struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // A string field representing the greeting message.
}
...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x7a, 0x75, 0x75, 0x6e, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x6f, 0x2f, 0x70, 0x72, 0x6f,
